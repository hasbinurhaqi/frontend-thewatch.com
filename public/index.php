   ...
   <body id="page-top" class="index">
      ...
      <div id="o-wrapper" class="o-wrapper">
         <main class="o-content">
            ...
            <!--- HOMEPAGE SECTION -->
               <?php include 'layout/partials/module/homepage/sections/belanja.php'; ?>
               <?php include 'layout/partials/module/homepage/sections/brand_terpopuler.php'; ?>
               <?php include 'layout/partials/module/homepage/sections/featured_brands.php'; ?>
               <?php include 'layout/partials/module/homepage/sections/jurnal.php'; ?>
               <hr>
      ...
      <?php include 'layout/partials/scripts/homepage_scripts.php'; ?>
   </body>
</html>