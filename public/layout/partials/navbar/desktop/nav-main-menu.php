         ...
         <div class="navbar-header page-scroll box-logo">
            ...
            <div class="hidden-lg">
               ...
               <div class="col-sm-10 col-xs-10 menu-mobile custom-search menu-left pleft0 pright0">
                  ...
                  <img onclick="search_mobile('/category/search?q=')" src="assets/img/icons/nav-home/icon-search.png" alt="img" />
               </div>
            </div>
         </div>
               ...
               <li class="icons">
                  ...
                  <div class="mn-header submenu view-cart scroll" id="box-search">
                     <div class="input-group searchform">
                        <!-- <span class="input-group-addon"><img src="/img/icons/search.png"></span> -->
                  ...
                  <div class="mn-header submenu view-cart" id="box-cart">
                     <div class="row cart-line">
                        <div class="col-lg-6 col-md-6 col-sm-6 clearleft cart-title-box">
                           <span class="cart-title fsize-18"><span class="gotham-medium fcolor69">Total Pesanan:</span> <span class="gotham-light">0 Item</span></span>
                        </div>
                     </div>
                     ...
                     <div class="col-lg-12 col-md-12 col-sm-12 clearright clearleft">
                        <div class="row checkout-btn-box">
                           <a class="blue-round talign-center cart-pay gotham-light fsize-14" href="/watches/all-product">Isi Keranjang Belanja</a>
                        </div>
                     </div>
                  </div>
               </li>
