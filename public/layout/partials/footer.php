      ...
      <div class="row">
         <div class="hidden-xs hidden-sm hidden-md col-lg-8 col-md-8 col-sm-8 clearleft footer-index">
            ...
            <div class="hidden-xs hidden-sm hidden-md col-lg-6 col-md-6 col-sm-6 clearleft footer caption">
               ...
               <br><br>
               <div class="footer follow-us caption">Dapatkan voucher Rp 100,000,-* jika anda berlangganan newsletter kami.</div>
               <br><br>
         ...
         <div class="hidden-xs hidden-sm hidden-md col-lg-4 col-md-4 col-sm-4 footer caption top-metode clearright">
            ...
            <div class="footer follow-us icons mbottom5">
               <!--<img src="/img/logos/uob.png" class="logo-payment">-->
         ...
         <div class="hidden-lg col-xs-12 footer caption margin-top-5 footer-index">
            ...
            <div class="footer follow-us caption mobile-text-1">Dapatkan voucher Rp 100,000,-* jika anda berlangganan newsletter kami.</div>
            <br >
            <div class="footer newsletter caption mobile-text-2">CUSTOMER SERVICE</div>
            <br>
            ...
            <div class="footer-mobile-link">
               <div class="col-xs-12 footer-mobile-link-content"><a href="/about">TENTANG KAMI</a></div>
               <div class="col-xs-12 footer-mobile-link-content"><a href="/store">LOKASI TOKO</a></div>
               <div class="col-xs-12 footer-mobile-link-content"><a href="/contact">HUBUNGI KAMI</a></div>
               <div class="col-xs-12 footer-mobile-link-content"><a href="/corporateorder">CORPORATE ORDER</a></div>
               <div class="col-xs-12 footer-mobile-link-content"><a href="/warranty">GARANSI & SERVIS</a></div>
               <div class="col-xs-12 footer-mobile-link-content"><a href="/faq">FAQ</a></div>
               <div class="col-xs-12 footer-mobile-link-content"><a href="/privacy">KEBIJAKAN PRIVASI</a></div>
               <div class="col-xs-12 footer-mobile-link-content clearleft-mobile clearright-mobile"><a href="/shipping-information">INFORMASI PENGIRIMAN</a></div>
