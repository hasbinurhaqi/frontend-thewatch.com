...
<section class="ptop1" style="padding-top:0px;padding-bottom:0;">
   ...
   <div style="position: relative;">
      <img src="//thewatch.imgix.net/landing/corporateorder/corporate-banner-desktop.jpg" class="img-responsive hidden-xs" style="display: block;margin: auto;">
      <img src="//thewatch.imgix.net/landing/corporateorder/corporate-banner-mobile.jpg" class="img-responsive hidden-lg hidden-md hidden-sm" style="display: block;margin: auto;">
   </div>
   <!--    </div>-->
   <!--</div>-->
</section>
   ...
   <div class="container">
      <div class="row">
         ...
         <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 clearleft">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 clearright-mobile clearleft-mobile clearleft clearright">
               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 clearright-mobile clearleft-mobile gotham-light clearleft clearright corporate-mobile">
                  ...
                  Semua produk yang masuk ke dalam toko The Watch Co. telah melalui proses quality control yang ketat untuk menjaminkan kualitas tertinggi dalam setiap produk kami.
                  <br>
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 new-line"></div>
         ...
         <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 clearright">
            <form id="w0" class="corporate_form" action="/corporateorder" method="post">
               <input type="hidden" name="_csrf" value="PFoZi447EsgmOuq4b6JpTWx8-QEsWGDnDvMYbcCBYvQPFX_AvW56oUVU2NtX0AgiPDC8V0QeBN5Iv1ofjMIUzQ==">
         ...
         <div class="col-lg-12 clearleft" >
            ...
            <div class="corporate-custom">
               <img src="https://www.thewatch.co/img/icons/icon-qwer-85.png" 
                  >
               <img src="https://www.thewatch.co/img/icons/icon-qwer-84.png" 
                  >
            </div>
         </div>
      </div>
