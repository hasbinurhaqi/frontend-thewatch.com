   ...
   <div class="container">
      <div class="row">
         ...
         <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 contact-us-left pright2">
               ...
               <div class="form-inquiries myprofile customer-info">
                  <form method="post" action="contact/sendinquiries">
                     ...
                     <div class="col-lg-9 col-sm-9 col-xs-8" style="padding-right: 0px; padding-left: 0px; padding-bottom: 4%;">
                     ...
                     <div class="col-lg-12 col-xs-12" style="padding-right: 0px;">
                        <div class="pull-right">
                           <a class="edit" onclick="submit()">SUBMIT</a>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 customer-after-sales contact-us-right pleft2 clearright remove-padding">
               <div class="gotham-medium title-contact-us">
                  CUSTOMER & AFTER SALES SERVICE
               </div>
               <div class="form-inquiries myprofile customer-info hidden-xs" style="margin-bottom: 10%;">
                  <table>
                     <tr>
               ...
               <div class="form-inquiries myprofile customer-info hidden-lg hidden-md hidden-sm" style="margin-bottom: 10%;">
               ...
               <div class="form-inquiries myprofile customer-info gotham-light">
                  LINE ID : @thewatchco
                  <br/>
                  (please include the '@' symbol)
                  <br/>
                  <img src='https://www.thewatch.co/img/logos/qrline.jpg' width='25%' style='margin-top: 2%;'/>
               </div>
            </div>
         </div>
      </div>
